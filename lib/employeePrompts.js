...
const employeeViewMenuPrompt = [{
    ...
    type: "list",
    choices: ["View All", "View by Role", "View by Department", "Exit to Previous"]
}];
...
module.exports = { employeeMenuPrompt, employeeViewMenuPrompt, employeeViewRolePrompt, employeeViewDepartmentPrompt, employeeAddPrompt, employeeUpdateSelectPrompt, employeeUpdateOptionsPrompt, employeeUpdateManagerPrompt, employeeUpdateRolePrompt, employeeDeletePrompt };